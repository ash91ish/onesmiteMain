...
export default function Verticals() {
  ...
  <p className="mb-3 text-xs leading-relaxed text-slate-300">
    A next-generation AI-aware assessment and learning workflow platform built
    for schools, institutes, and independent educators — currently under active
    development with a scalable SaaS foundation and long-term automation
    roadmap.
  </p>
  ...
  <div className="mt-auto flex items-center justify-between text-[11px] text-slate-400">
    <span>Stage: Under Active Development</span>
